...
<div id="temp_container">
    	...
    	<ul>
            ...
            <li><a href = "../payment/user-payment.php"> Payment History</a></li> 
...
<form action="user-payment.php" method="POST" class="form-inline">
...
<?php
   ...
   <tbody>';
    ...
    if(isset($_POST['date'])){
        ...
        $sql = "SELECT * FROM payment WHERE date='$newDate' AND user_id='$userid';";
